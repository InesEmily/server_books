insert into book (title, author) values ('Oryx and Crake', ''); /*1*/
insert into book (title, author) values ('The year of the flood', '');/*2*/
insert into book (title, author) values ('MaddAddam', '');/*3*/
insert into book (title, author) values ('1Q84', '');/*4*/
insert into book (title, author) values ('De opwindvogelkronieken', '');/*5*/
insert into book (title, author) values ('Design Patterns', '');/*6*/
insert into book (title, author) values ('Anderland: De Stad Van Gouden Schaduw', ''); /*7*/
insert into book (title, author) values ('Anderland:  Rivier van blauw vuur', ''); /*8*/
insert into book (title, author) values ('Anderland:  Berg van zwart glas', ''); /*9*/
insert into book (title, author)values ('Anderland:  Zee van zilveren licht', ''); /*10*/
insert into book (title, author) values ('Neuromancer ', ''); /*11*/
